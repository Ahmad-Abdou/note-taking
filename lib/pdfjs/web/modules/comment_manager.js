...
function saveComments() {
    ...
    console.log('[Comments] saveComments called with key:', key, 'saving', comments.length, 'comments');
    chrome.storage.local.set({ [key]: comments }, () => {
        console.log('[Comments] Save complete');
    });
}

function loadComments() {
    const key = getCommentStorageKey();
    console.log('[Comments] loadComments called with key:', key);
...
function renderAllComments() {
    console.log('[Comments] renderAllComments called, rendering', comments.length, 'comments');
...
function renderComment(comment) {
    console.log('[Comments] renderComment for page', comment.page, 'rects:', comment.rects?.length);
    const pageElement = document.querySelector(`.page[data-page-number="${comment.page}"]`);
    if (!pageElement) {
        console.log('[Comments] Page element not found for page', comment.page);
        return;
    }
    ...
    if (!container) {
        ...
        console.log('[Comments] Created new comment-highlight-container');
    }
...
function initCommentSystem() {
    console.log('[Comments] initCommentSystem called');
