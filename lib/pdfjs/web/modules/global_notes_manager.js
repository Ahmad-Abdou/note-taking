    ...
    deleteAssociatedHighlight(highlightId) {
        ...
        if (typeof window.deleteHighlight === 'function') {
            try {
                ...
                console.log('deleteHighlight not available or failed:', e);
            }
        }
    ...
    goToNote(note) {
        ...
        const navigateToPageInCurrentViewer = (page) => {
            ...
            if (typeof window.scrollToPage === 'function') {
                try {
                    ...
                    console.log('scrollToPage failed:', e);
                }
            }
            ...
            try {
                ...
                console.log('hash navigation failed:', e);
            }
        ...
        if (note.pdfUrl.startsWith('library://')) {
            ...
            try {
                ...
                console.log('Library same-PDF check failed:', e);
            }
            ...
            console.log('GoToNote comparison:', { currentFile, notePdfUrl: note.pdfUrl, isSamePdf });
            ...
            if (isSamePdf) {
                ...
                console.log('Navigating to different PDF:', targetUrl);
