...
class DrawingManager {
    ...
    toggleDrawingMode(force = null) {
        ...
        console.log('Drawing mode toggled:', newState, 'Canvases:', Object.keys(this.canvases));
    ...
    setupCanvasEvents(canvas, pageNum) {
        ...
        const startDrawing = (e) => {
            ...
            console.log('Start drawing at:', point, 'Tool:', this.currentTool);
        ...
        const stopDrawing = (e) => {
            ...
            console.log('Stop drawing, stroke points:', this.currentStroke?.points?.length);
    ...
    enableDrawingOnPages() {
        ...
        Object.values(this.canvases).forEach(canvas => {
            ...
            console.log('Canvas activated:', canvas.dataset.pageNumber,
                'classList:', canvas.classList.toString(),
                'pointer-events:', getComputedStyle(canvas).pointerEvents,
    ...
    clearCanvasReferences() {
        console.log('DrawingManager: Clearing canvas references for zoom');
