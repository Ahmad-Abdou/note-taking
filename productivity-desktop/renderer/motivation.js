...
function getStreakBreakCost() {
    ...
    return {
        ...
        nextMilestone,
        daysToMilestone,
        message: `Breaking your ${currentStreak}-day streak means losing ${totalStreakXP} XP in potential bonuses. You're only ${daysToMilestone} days from a ${nextMilestone}-day milestone!`
    };
}

/**
 * Show streak warning before an action that would break it
 */
