...
function showDailyTaskReminderModal(tomorrowTasks, todayTasks, tomorrowDate) {
    ...
    addTaskBtn?.addEventListener('click', async () => {
        // Mark as dismissed and remove the modal BEFORE opening task modal
        ...
        // Now open task modal with tomorrow's date pre-filled
...
async function submitAccountabilityCheckin(modal) {
    try {
        ...
        stats.checkinStreak++;
        if (stats.checkinStreak > stats.longestCheckinStreak) {
...
// Accountability check-in exports
